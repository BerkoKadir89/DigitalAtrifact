                    ...
                    if (BaseUser.isMatch(password, username)) {
                        ...
                        while (true) {
                            ...
                            switch (loggedinOption) {
                                case 1 -> {
                                    logic.bulkingOrCutting(user); // gives daily calorie a user should have to bulk or
                                                                  // cut
                                }
                                ...
                                case 4 -> {
                                    logic.weightTrackerMenu(user, username); // used to log,show and get analysis of
                                                                             // weight
                                }
